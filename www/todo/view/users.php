            ...
            <div class="tab-pane fade <?php echo $activeTab === 'approved' ? 'show active' : ''; ?>" id="approved" role="tabpanel">
                ...
                <?php else: ?>
                    ...
                    <?php if($approved_total_pages > 1): ?>
                        <nav aria-label="Approved users pagination" class="mt-3">
                            <ul class="pagination justify-content-center mb-0">
                                <li class="page-item <?php echo $approved_page <= 1 ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="?approved_page=<?php echo max(1, $approved_page - 1); ?>">Prev</a>
                                </li>
                                <?php for($p = 1; $p <= $approved_total_pages; $p++): ?>
                                    <li class="page-item <?php echo $p == $approved_page ? 'active' : ''; ?>">
                                        <a class="page-link" href="?approved_page=<?php echo $p; ?>"><?php echo $p; ?></a>
                                    </li>
                                <?php endfor; ?>
                                <li class="page-item <?php echo $approved_page >= $approved_total_pages ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="?approved_page=<?php echo min($approved_total_pages, $approved_page + 1); ?>">Next</a>
                                </li>
                            </ul>
                        </nav>
                    <?php endif; ?>
            ...
            <div class="tab-pane fade <?php echo $activeTab === 'inactive' ? 'show active' : ''; ?>" id="inactive" role="tabpanel">
                ...
                <?php else: ?>
                    ...
                    <?php if($inactive_total_pages > 1): ?>
                        <nav aria-label="Inactive users pagination" class="mt-3">
                            <ul class="pagination justify-content-center mb-0">
                                <li class="page-item <?php echo $inactive_page <= 1 ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="?inactive_page=<?php echo max(1, $inactive_page - 1); ?>">Prev</a>
                                </li>
                                <?php
                                ...
                                if ($start_page > 1) {
                                    echo '<li class="page-item"><a class="page-link" href="?inactive_page=1">1</a></li>';
                                    if ($start_page > 2) {
                                ...
                                for ($i = $start_page; $i <= $end_page; $i++) {
                                    ...
                                    echo '<li class="page-item ' . $active . '"><a class="page-link" href="?inactive_page=' . $i . '">' . $i . '</a></li>';
                                }
                                ...
                                if ($end_page < $inactive_total_pages) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="?inactive_page=' . $inactive_total_pages . '">' . $inactive_total_pages . '</a></li>';
                                }
                                ?>
                                <li class="page-item <?php echo $inactive_page >= $inactive_total_pages ? 'disabled' : ''; ?>">
                                    <a class="page-link" href="?inactive_page=<?php echo min($inactive_total_pages, $inactive_page + 1); ?>">Next</a>
                                </li>
                            </ul>
                        </nav>
                    <?php endif; ?>
