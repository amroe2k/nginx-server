            ...
            <div class="col-md-12">
                ...
                <div class="row mt-4 align-items-stretch g-3" id="sticky-notes-card">
                    <div class="col-md-4 d-flex">
                        <div class="card card-soft-blue mb-3 h-100 w-100 shadow-sm">
                    ...
                    <div class="col-md-4 d-flex">
                        <div class="card card-soft-green mb-3 h-100 w-100 shadow-sm">
                            <div class="card-body d-flex flex-column">
                    ...
                    <?php if(isAdmin()): ?>
                    <div class="col-md-4 d-flex">
                        <div class="card card-soft-slate mb-3 h-100 w-100 shadow-sm">
                            <div class="card-body d-flex flex-column">
